...
/**
 * BaseViewController is a base ViewController for all the state related ViewControllers and it conforms to the protocols needed for alertview
 * and app state preservation and restoration process.
 */
